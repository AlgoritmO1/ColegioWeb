...
<br>
<div class="container">
    <center><h2 style="color:#FDF3E7">Editar matricula</h2></center>
    <hr>
    <br>
    <div class="divTable" style="width: 100%;border: 1px solid #000;" >
        <div class="divTableBody">
            ...
            <form class="divTableRow" method="GET" action="./servletMatricula">
                ...
                <div class="divTableCell"> <center><button type="submit" value="Guardar edicion" name="accion" class="btn btn-info">
